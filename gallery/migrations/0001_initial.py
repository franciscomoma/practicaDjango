# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-04-29 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gallery.Picture', verbose_name='Picture')),
            ],
        ),
        migrations.CreateModel(
            name='Size',
        ...
        migrations.AddField(
            ...
            name='size',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gallery.Size', verbose_name='Size'),
        ),
    ]
